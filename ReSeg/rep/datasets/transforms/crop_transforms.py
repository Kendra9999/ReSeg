...
class Crop3DPatch(Transform):
    ...
    """
    def __init__(self, keys: list[str], label_keys: list[str],
                 scale=(0.8, 1.2), patch_size=(96, 96, 96)):
        self.keys = keys
    ...
    def __call__(self, data):
        d = dict(data)
        for key, label_key in zip(self.keys, self.label_keys):
            img = d[key]
            label = d[label_key]
            mesh = d[key + "_mesh"]
            ...
            label_p1 = copy.deepcopy(label)
            label_p2 = copy.deepcopy(label)
            mesh_p1 = copy.deepcopy(mesh)
            mesh_p2 = copy.deepcopy(mesh)
            d[key + "_p1"] = img_p1
            d[key + "_p2"] = img_p2
            d[key + "_p1_label"] = label_p1
            d[key + "_p2_label"] = label_p2
            ...
            p1_crop_transform = SpatialCropd(
                    keys=[key + "_p1", key + "_p1_label", key + "_p1_mesh"],
            ...
            p2_crop_transform = SpatialCropd(
                    keys=[key + "_p2", key + "_p2_label", key + "_p2_mesh"],
            ...
            resize_transform = Resized(
                    keys=[key + "_p1", key + "_p1_label", key + "_p1_mesh", 
                          key + "_p2", key + "_p2_label", key + "_p2_mesh"],
                    spatial_size=self.patch_size,
                    mode=("area", "nearest", "bilinear", 
                          "area", "nearest", "bilinear"),
                )
            d = resize_transform(d)
            
        return d

def get_crop_transforms(crop_size = (96, 96, 96), img_size = (128, 128, 128)):
    """
    Crop two overlap patches from a 3D volume.
    """
    train_transforms = Compose(
        [
            ...
            Crop3DPatch(keys=["view1", "view2"], 
                        label_keys=["label", "label"], 
                        patch_size=crop_size),
            Resized(
                keys=["view1", "view2", "label", "view1_mesh", "view2_mesh"],
                spatial_size=crop_size,
                mode=("area", "area", "nearest", "bilinear", "bilinear"),
            ),
...
if __name__ == "__main__":
    ...
    from online_transforms import get_online_transforms
    ...
    ax[0, 1].set_title("view1 label")
    ax[0, 1].imshow(crop_data["label"][0, :, :, 60])
    ax[1, 1].set_title("view1_p1 label")
    ax[1, 1].imshow(crop_data["view1_p1_label"][0, :, :, 60])
    ax[2, 1].set_title("view1_p2 label")
    ax[2, 1].imshow(crop_data["view1_p2_label"][0, :, :, 60])
    ax[0, 2].set_title("view1 mesh")
    ax[0, 2].imshow(crop_data["view1_mesh"][:, :, :, 60].permute(1, 2, 0) / 128.0)
    ax[1, 2].set_title("view1_p1 mesh")
    ax[1, 2].imshow(crop_data["view1_p1_mesh"][:, :, :, 60].permute(1, 2, 0) / 128.0)
    ax[2, 2].set_title("view1_p2 mesh")
    ax[2, 2].imshow(crop_data["view1_p2_mesh"][:, :, :, 60].permute(1, 2, 0) / 128.0)
    ax[0, 3].set_title("view2")
    ax[0, 3].imshow(transform_data["view2"][0, :, :, 60], cmap="gray")
    ax[1, 3].set_title("view2_p1")
    ax[1, 3].imshow(crop_data["view2_p1"][0, :, :, 60], cmap="gray")
    ax[2, 3].set_title("view2_p2")
    ax[2, 3].imshow(crop_data["view2_p2"][0, :, :, 60], cmap="gray")
    ax[0, 4].set_title("view2 label")
    ax[0, 4].imshow(crop_data["label"][0, :, :, 60])
    ax[1, 4].set_title("view2_p1 label")
    ax[1, 4].imshow(crop_data["view2_p1_label"][0, :, :, 60])
    ax[2, 4].set_title("view2_p2 label")
    ax[2, 4].imshow(crop_data["view2_p2_label"][0, :, :, 60])
    ax[0, 5].set_title("view2 mesh")
    ax[0, 5].imshow(crop_data["view2_mesh"][:, :, :, 60].permute(1, 2, 0) / 128.0)
    ax[1, 5].set_title("view2_p1 mesh")
    ax[1, 5].imshow(crop_data["view2_p1_mesh"][:, :, :, 60].permute(1, 2, 0) / 128.0)
    ax[2, 5].set_title("view2_p2 mesh")
    ax[2, 5].imshow(crop_data["view2_p2_mesh"][:, :, :, 60].permute(1, 2, 0) / 128.0)
    ...
    ax[0,0].set_title("view1_p1")
    ax[0,0].imshow(crop_data["view1_p1"][0, qt[0]-20:qt[0]+20, qt[1]-20:qt[1]+20, qt[2]], cmap="gray")
    ax[0,1].set_title("view1_p2")
    ax[0,1].imshow(crop_data["view1_p2"][0, view1_p2_kt[0][0]-20:view1_p2_kt[0][0]+20, 
                                       view1_p2_kt[1][0]-20:view1_p2_kt[1][0]+20, view1_p2_kt[2][0]], cmap="gray")
    ax[0,2].set_title("view2_p1")
    ax[0,2].imshow(crop_data["view2_p1"][0, view2_p1_kt[0][0]-20:view2_p1_kt[0][0]+20,
                                       view2_p1_kt[1][0]-20:view2_p1_kt[1][0]+20, view2_p1_kt[2][0]], cmap="gray")
    ax[0,3].set_title("view2_p2")
    ax[0,3].imshow(crop_data["view2_p2"][0, view2_p2_kt[0][0]-20:view2_p2_kt[0][0]+20,
                                       view2_p2_kt[1][0]-20:view2_p2_kt[1][0]+20, view2_p2_kt[2][0]], cmap="gray")
    ax[1,0].set_title("view1_p1_label")
    ax[1,0].imshow(crop_data["view1_p1_label"][0, qt[0]-20:qt[0]+20, qt[1]-20:qt[1]+20, qt[2]])
    ax[1,1].set_title("view1_p2_label")
    ax[1,1].imshow(crop_data["view1_p2_label"][0, view1_p2_kt[0][0]-20:view1_p2_kt[0][0]+20, 
                                       view1_p2_kt[1][0]-20:view1_p2_kt[1][0]+20, view1_p2_kt[2][0]])
    ax[1,2].set_title("view2_p1_label")
    ax[1,2].imshow(crop_data["view2_p1_label"][0, view2_p1_kt[0][0]-20:view2_p1_kt[0][0]+20,
                                       view2_p1_kt[1][0]-20:view2_p1_kt[1][0]+20, view2_p1_kt[2][0]])
    ax[1,3].set_title("view2_p2_label")
    ax[1,3].imshow(crop_data["view2_p2_label"][0, view2_p2_kt[0][0]-20:view2_p2_kt[0][0]+20,
                                       view2_p2_kt[1][0]-20:view2_p2_kt[1][0]+20, view2_p2_kt[2][0]])
